...
@section('admin-content')
    <div class="col-12">
        ...
        <div class="col-12">
            <form class="col-12" action="{{ route('categories.update', ['id' => $category->id]) }}" method="POST"  enctype="multipart/form-data">
                @csrf
                @method('put')
                ...
                <div class="form-group col-12 row">
                    ...
                    <div class="col-8 row">
                        @if($category->category_icon)
                            <img id="category-pic" src="{{ asset('storage/' . $category->category_icon) }}" class="categories-big"/>
                        @else
